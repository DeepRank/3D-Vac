...
python build_pssm_input.py --output-folder /projects/0/einf2380/data/pMHCI/pssm_raw/all_mhc --input-file-db1 /projects/0/einf2380/data/external/processed/I/BA_pMHCI_all.csv
