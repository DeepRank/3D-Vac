...
export original_pdb='/projects/0/einf2380/data/pMHCII/db2_selected_models/BA/55001_56000/BA_55613_2IAN/pdb/BA-55613.BL00200001.pdb'
...
srun --job-name orient_peptides \
    ...
    python -u orient_on_pept_PCA.py --pdbs-path $pdbs_path \
