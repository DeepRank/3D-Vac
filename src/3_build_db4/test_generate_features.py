...
arg_parser.add_argument("--input-folder", "-i",
    ...
    """,
    default="/projects/0/einf2380/data/pMHCI/features_input_folder/test_case"
)
arg_parser.add_argument("--h5out", "-o",
    help="""
    Output hdf5 file
    """,
    default="/projects/0/einf2380/data/pMHCI/features_output_folder/CNN/test_case/test_case.hdf5"
)
