...
data = 'pMHCI'
resolution = 'atomic' # either 'residue' or 'atomic'
interface_distance_cutoff = 5.5 # max distance in Å between two interacting residues/atoms of two proteins
cpu_count = 128 # remember to set the same number in --cpus-per-task in 1_generate_hdf5.sh
##################################
...
if __name__ == "__main__":
	...
	queries = QueryCollection() # one quesy one data point
