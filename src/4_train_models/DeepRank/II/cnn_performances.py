...
arg_parser.add_argument("--cluster", "-c",
    help="By providing this argument, will perform a scikit LeaveOneGroupOut crossvalidation grouped by cluster, shuffled KFold otherwise.",
    default=False,
    action="store_true"
)
...
model = NeuralNet(test_db,
    ...
    outdir = outdir,
    pretrained_model=f"{a.output_dir}/{rank}/best_test_model.pth.tar"
)
