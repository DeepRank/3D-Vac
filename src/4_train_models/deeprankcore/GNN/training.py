...
exp_name = 'exp_100k_std_transf_bs64_naivegnn1_wloss_cl_peptide_'
exp_date = True # bool
exp_suffix = ''
# Target/s
...
cluster_dataset = 'cl_peptide' # 'cl_peptide' # 'cl_peptide2' # 'cl_peptide2_10set' # 'cl_allele' # 'allele_type' # None
