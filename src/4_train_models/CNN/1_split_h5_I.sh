...
python ./split_h5.py \
--csv-file /projects/0/einf2380/data/external/processed/I/BA_pMHCI_human_quantitative_only_eq_alleleclusters.csv \
--features-path /projects/0/einf2380/data/pMHCI/features_output_folder/CNN/exp_nmers_all_HLA_quantitative/ \
--output-path /projects/0/einf2380/data/pMHCI/features_output_folder/CNN/split_HLA_quant_pept_clust \
--cluster \
--cluster-column allele_clustering \
--test-clusters 3 \
--parallel 64
