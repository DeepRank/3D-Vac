...
# --job-name=test_reg \
# train_single_fold.sh cnn_onefold_reg.py shuffled_test CnnReg4ConvKS3Lin128SigmoidChannExpandXYZ \
...
# --job-name=test_class \
# train_single_fold.sh cnn_onefold.py shuffled_test CnnClass4ConvKS3Lin128ChannExpandXYZ \
# /projects/0/einf2380/data/pMHCI/features_output_folder/CNN/splits_HLA_quant_shuffled_subsample/shuffled/0 \
# 4 128
...
--job-name=shuff_reg \
train_single_fold.sh cnn_onefold_reg.py shuffled_noPSSM_sumFeat_bn CnnReg4ConvKS3Lin128SigmoidChannExpandXYZ \
...
--job-name=pept_reg \
train_single_fold.sh cnn_onefold_reg.py clustPept_noPSSM_sumFeat_bn CnnReg4ConvKS3Lin128SigmoidChannExpandXYZ \
...
--job-name=alle_reg \
train_single_fold.sh cnn_onefold_reg.py clustAllele_noPSSM_sumFeat_bn CnnReg4ConvKS3Lin128SigmoidChannExpandXYZ \
...
train_single_fold.sh cnn_onefold.py shuffled_noPSSM_sumFeat_bn CnnClass4ConvKS3Lin128ChannExpandXYZ \
/projects/0/einf2380/data/pMHCI/features_output_folder/CNN/splits_HLA_quant_shuffled/shuffled/0 \
15 128 \
## Peptide clustered
...
--job-name=pept_class \
train_single_fold.sh cnn_onefold.py clustPept_noPSSM_sumFeat_bn CnnClass4ConvKS3Lin128ChannExpandXYZ \
/projects/0/einf2380/data/pMHCI/features_output_folder/CNN/splits_HLA_quantitative_gibbs_clust_10_3/clustered/0 \
15 128 \
## Allele clustered
...
--job-name=alle_class \
train_single_fold.sh cnn_onefold.py clustAllele_noPSSM_sumFeat_bn CnnClass4ConvKS3Lin128ChannExpandXYZ \
/projects/0/einf2380/data/pMHCI/features_output_folder/CNN/splits_HLA_quant_allele_clusters/clustered/0 \
15 128 \